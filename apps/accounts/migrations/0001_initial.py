    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('matric_no', models.CharField(db_index=True, max_length=50, unique=True, verbose_name='Matriculation / Staff ID')),
                ('role', models.CharField(choices=[('admin', 'System Administrator'), ('electoral_officer', 'Electoral Officer'), ('candidate', 'Candidate'), ('voter', 'Voter')], default='voter', max_length=30)),
